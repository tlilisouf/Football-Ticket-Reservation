...
<title>stade olympique de Gafsa</title>
<body>
	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent">Le stade olympique de Gafsa est un
					stade multidisciplinaire de Gafsa (Tunisie). <span>Il
						accueille les matchs d'El Gawafel sportives de Gafsa.Sa capacité
						d'accueil est de 7 000 spectateurs. </span><a href=""
			...
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de stade du lympique de Gafsa</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
