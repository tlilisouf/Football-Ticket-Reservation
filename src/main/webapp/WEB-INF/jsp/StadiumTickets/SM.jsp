...
<title>stade Midoun</title>
<body>

	<jsp:include page="../Header.jsp" />
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7">Le stade Midoun
				est un stade tunisien situé dans la Ville Djerba-Midoun. Longtemps
				stade principal de Espoir sportif de Jerba Midoun avec 10 000
				spectateurs.</div>
		</div>
	</section>
	<nav class="container">
