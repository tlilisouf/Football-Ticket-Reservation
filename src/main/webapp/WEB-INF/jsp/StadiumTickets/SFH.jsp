...
<title>stade Farhat-Hached</title>
<body>
	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent">Le stade Farhat-Hached est un stade
					de football situé sur l'archipel des Kerkennah en<span>
						Tunisie. Bâti à Remla sur l'île de Chemla, c'est le principal
						équipement sportif des Kerkennah.Sa capacité d'accueil est de 2000
						spectateurs.</span><a href="" class="morelink center-block text-center">Lire
						plus</a>
				</span>
			</div>
		</div>
