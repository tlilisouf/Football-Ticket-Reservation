...
<title>stade du 15-Octobre</title>
<body>
	...
	<section class="container">
		<div class="row">
			...
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le stade du 15-Octobre (ملعب 15
					أكتوبر) est un stade tunisien situé à Bizerte (65 kilomètres au
					nord-ouest de Tunis). Il dispose d'une capacité de 20 000 places
					dont<span> 4 000 sont couvertes Ce stade a abrité des matchs
						de la CAN 2004 , mais il est habituellement utilisé par le Club
						athlétique bizertin.</span><a href=""
