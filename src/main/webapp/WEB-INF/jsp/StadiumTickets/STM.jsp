...
<title>stade Taïeb Mehiri</title>
<body>

	<jsp:include page="../Header.jsp" /><section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le stade Taïeb Mehiri ( ملعب
					الطيّب المهيري) est le stade principal de la ville de Sfax. Il
					porte le nom de l'ancien ministre Taïeb Mehiri. Bien qu'il soit
					polyvalent, il est le plus souvent<span> associé au
						football. L'équipe du Club sportif sfaxien y a ainsi élu
						domicile.Construit en 1938, il est rénové en 2004 pour accueillir
						la Coupe d'Afrique des nations de football 2004. Il a une capacité
						de 11 000 places. </span><a href=""
