...
<title>stade olympique de Médenine</title>
<body>

	<jsp:include page="../Header.jsp" /><section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le stade olympique de Médenine est
					le stade sportif principal de <span>Médenine.Il accueille
						les matchs d'olympique de Médenine. Sa capacité d'accueil est de
						6000 spectateurs. </span><a href=""
			...
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de stade olympique de MÃ©denine</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
