...
<title>stade olympique de Radès</title>
<body>
	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">Le stade
				olympique de Radès est un stade situé à Radès, à une dizaine de
				kilomètres au sud-est du centre-ville de Tunis (Tunisie), au cœur de
				la Cité olympique.</div>
		</div>
	</section>
	<nav class="container">
		<div class="row">
			<section class="col-sm-12 ">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						Associés à olympique de Radès</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
