...
<title>stade Abdelaziz Chtioui</title>
<body>
	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le stade Abdelaziz Chtioui (ملعب
					عبدالعزيز شتوي) est un stade sportif multidisciplinaire de La <span>Marsa
						(Tunisie).Il accueille les matchs de l'Avenir sportif de La Marsa.
						Sa capacité d'accueil est de 6 000 spectateurs. </span><a href=""
