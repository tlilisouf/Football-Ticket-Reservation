	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le stade municipal de de Ben
					Guerdane est le stade sportif principal de <span>Ben
						Guerdane.Il accueille les matchs d' Union Sportive de Ben Guerdane
						. Sa capacité d'accueil est de 6 500 spectateurs. </span><a href=""
			...
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de stade du municipal de Ben Guerdane</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
