...
<title>stade du kef</title>
<body>

	<jsp:include page="../Header.jsp" />
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">Le stade du kef
				est un stade tunisien situé à Kef.Il dispose d'une capacité de 9000
				places utilisé par le Club Olympique du Kef.Lire plus</div>
		</div>
	</section>
