...
<title>stade municipal de Kasserine</title>
<body>
	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le stade municipal de Kasserine
					(الملعب الرياضي بالقصرين) est le stade sportif principal de <span>Kasserine.Il
						accueille les matchs de l'Avenir sportif de Kasserine. Sa capacité
						d'accueil est de 10 000 spectateurs. </span><a href=""
			...
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de stade du municipal de Kasserine</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
