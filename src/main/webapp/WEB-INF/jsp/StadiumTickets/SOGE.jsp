...
<title>stade olympique de Gabès</title>
<body>
	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">Le stade
				olympique de Gabès (الملعب الأولمبي بقابس), est le principal stade
				de football de Gabès (Tunisie).</div>
		</div>
	</section>
	<nav class="container">
		<div class="row">
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de stade du olympique de GabÃ¨s</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
