...
<title>stade municipal de Hammam Lif</title>
<body>
	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent">Le stade municipal de Hammam Lif
					(الملعب البلدي بحمام الأنف) est un stade sportif <span>multidisciplinaire
						de Hammam Lif (Tunisie) renouvelé en 2003.Il accueille les matchs
						du Club sportif de Hammam Lif. Sa capacité d'accueil est de 7 200
						spectateurs1.</span><a href="" class="morelink center-block text-center">Lire
						plus</a>
				</span>
			</div>
		</div>
			...
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de stade municipal de Hammam Lif</h2>
				<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
