...
<title>Ajouter matches coupe</title>
</head>
		...
		<div class="row">
			...
			<nav class="col-sm-9">
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="active"><a href="AddMatchCup">Coupe
							Tunisie</a></li>
			...
			<div class="col-sm-9 matchManagement">
				<spring:url value="MatchCUPAdd" var="MatchCUPAdd" />
				<form class="form-horizontal" role="form" method="post"
					action="${MatchCUPAdd }" id="match">
