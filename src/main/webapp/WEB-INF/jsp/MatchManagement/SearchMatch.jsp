		...
		<div class="row">
			<div class="list-group col-sm-3">
				...
				<a href="MatchList" class="list-group-item">Afficher matches</a> <a
					href="SearchMatch.html" class="list-group-item active">Rechercher
			...
			<div class="col-sm-6">
				<spring:url value="matchSearch" var="matchSearch" />
				<form class="form-inline" role="form" method="post"
					action="${matchSearch }">
					<div class="form-group ">
						<input type="text" class="form-control" name="searchMatch" />
