...
<title>Ajouter Match Tunisie Espoir</title>
</head>
			...
			<nav class="col-sm-9">
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="active"><a
						href="AddMatchTunisiaEspoir">Equipe Espoir Tunisie</a></li>
				</ul>
			</nav>
			<div class="col-sm-9 matchManagement">
				<spring:url value="MatchTunisiaEspoirAdd"
					var="MatchTunisiaEspoirAdd" />
				<form class="form-horizontal" role="form" id="match" method="post"
					action="${MatchTunisiaEspoirAdd }">
					<div class="form-group col-sm-9" id="billing_TunisiaEspoir_match">
						<div class="col-sm-3">
							<input class="form-control" type="text" name="teamHome"
								value="Espoir" readonly="">
						</div>
						<div class="col-sm-7">
							<input class="form-control" type="text" name="teamAway"
								id="TunisiaEspoirMatch" placeholder="L'autre Equipe" value=""
								required />
						</div>
					</div>
