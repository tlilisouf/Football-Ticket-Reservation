...
<title>Ajouter Match ligue 2</title>
</head>
	...
	<div class="container margin-nav">
		<div class="row">
			...
			<nav class="col-sm-9">
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="active"><a
						href="AddMatchLigue2.html">Ligue II</a></li>
			...
			<div class="col-sm-9 matchManagement">
				<spring:url value="MatchLigue2Add" var="MatchLigue2Add" />
				<form class="form-horizontal" role="form" method="post"
					action="${MatchLigue2Add }" id="match">
					<jsp:include page="SelectLigue2.jsp"></jsp:include>
