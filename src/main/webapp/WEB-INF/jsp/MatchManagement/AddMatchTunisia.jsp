...
<title>Ajouter Match Tunisie</title>
</head>
		...
		<div class="row">
			<div class="list-group col-sm-3">
				<a href="AddMatchLigue1" class="list-group-item active">Ajouter
					...
					utlisateurs</a> <a href="../UserManagement/searchMember"
					class="list-group-item ">Rechercher utilisateurs</a> <a
					href="InnactivUsers" class="list-group-item ">Afficher
			...
			<nav class="col-sm-9">
				<ul class="nav nav-tabs">
					...
					<li role="presentation" class="active"><a
						href="AddMatchTunisia.html">Equipe Tunisie</a></li>
			...
			<div class="col-sm-9 matchManagement">
				<spring:url value="MatchTunisiaAdd" var="MatchTunisiaAdd" />
				<form class="form-horizontal" role="form" id="match" method="post"
					action="${MatchTunisiaAdd }">
					<div class="form-group col-sm-9" id="billing_Tunisia_match">
						<div class="col-sm-3">
						...
						<div class="col-sm-7">
							...
							<input class="form-control" type="text" name="teamAway"
								id="TunisiaMatch" placeholder="L'autre Equipe" value="" required />
