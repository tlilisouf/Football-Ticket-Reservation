	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/Stirzarzouna.png" var="logo" />
				<img src="${logo}" alt="SZ" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> La STIR sportive de Zarzouna (ستير
					جرزونة) est un club tunisien de football fondé en 1967 et basé à
					Zarzouna.<span> Il évolue durant la saison 2014-2015 en
						Ligue III Nord dont il remporte le championnat et accède en Ligue
						II.</span><a href="" class="morelink center-block text-center">Lire
						plus</a>
				</span>
			</div>
		</div>
