	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/benarous.png" var="logo" />
				<img src="${logo}" alt="SCBA" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">Le Sporting Club
				de Ben Arous est un club tunisien de football basé dans la ville de
				Ben Arous.Il évolue durant la saison 2014-2015 en Ligue II.</div>
		</div>
	</section>
	<nav class="container">
		<div class="row">
			<section class="col-sm-8 col-sm-offset-2 ">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de Sporting Club de Ben Arous</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
