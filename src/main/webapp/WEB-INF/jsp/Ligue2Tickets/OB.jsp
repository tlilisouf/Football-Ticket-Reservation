	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/Jendouba_sport.png" var="logo" />
				<img src="${logo}" alt="OB" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">L'Olympique de
				Béja (الأولمبي الباجي) ou OB est un club tunisien de football fondé
				à Béja en 1929.</div>
		</div>
	</section>
	<nav class="container">
