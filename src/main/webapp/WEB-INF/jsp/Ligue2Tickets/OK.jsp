	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/OK.png" var="logo" />
				<img src="${logo}" alt="OK" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> L'Olympique du Kef (arabe :
					أولمبيك الكاف) est un club tunisien de football fondé le 17 mai<span>
						1922.Il évolue durant la saison 2014-2015 en Ligue II avant d'être
						promu durant une saison en Ligue I. Il joue au stade du Kef qui a
						une capacité de 9 000 places.</span><a href=""
