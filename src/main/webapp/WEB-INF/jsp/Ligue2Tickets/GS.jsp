	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/gs.png" var="logo" />
				<img src="${logo}" alt="GS" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Grombalia Sports est un club de
					football de la ville de Grombalia en Tunisie Grombalia<span>
						Sports participe au championnat de Tunisie de football (Ligue I)
						en 1987-19881. En 2012-2013, il évolue en Ligue II. Après 26 ans,
						le club retrouve à nouveau la Ligue I pour la saison 2013-2014.</span><a
