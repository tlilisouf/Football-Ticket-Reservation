	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url
					value="/resources/images/ligue2/El_Makarem_de_Mahdia.png"
					"
					var="logo" />
				<img src="${logo}" alt="MM" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> El Makarem de Mahdia (مكارم
					المهدية) ou EMM est un club de football tunisien fondé en 1937. Il
					évolue en Ligue II en 2014-2015.En coupe, le meilleur résultat est
					obtenu en<span> 1975 où l'EMM dispute la finale contre
