	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/Fchammamet.jpg"
					var="logo" />
				<img src="${logo}" alt="FCH" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le Football Club Hammamet (arabe :
					نادي كرة القدم بالحمامات) ou FCH est un club tunisien de <span>footballfondé
						à Hammamet en 2001. Il évolue durant la saison 2014-2015 en Ligue
						II. Il joue au stade municipal d'Hammamet qui possède une capacité
						de 2 000 places.</span><a href=""
