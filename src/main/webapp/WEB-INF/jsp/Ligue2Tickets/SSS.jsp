	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/SSS.gif" var="logo" />
				<img src="${logo}" alt="SSS" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le Stade Sportif Sfaxien (الملعب
					الرياضي الصفاقسي) ou SSS (appelé parfois le « 3S ») est un club
					tunisien de football. Son surnom de SIAPE provient du nom de son
					sponsor<span> : la Société industrielle d'acide phosphorique
						et d'engrais rattachée au Groupe chimique tunisien.Le club passe
						sept saisons en Ligue I (niveau professionnel) et évolue depuis en
						Ligue III. Lors de la saison 2014-2015, il évolue en Ligue II.</span><a
