	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue2/tunisie_ust.jpg"
					var="logo" />
				<img src="${logo}" alt="UST" />

			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent">L’Union sportive de Tataouine est
					un club tunisien de football fondé en 1996, à la suite de
					l’unification de Tataouine Sport et de la Jeunesse sportive de
					Rogba. Il est basé dans <span>la ville de Tataouine.Il
						évolue en 2014-2015 en Ligue III Sud dont il remporte le
						championnat pour accéder en Ligue II.</span><a href=""
			...
			<section class="col-sm-8 col-sm-offset-2 ">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de Union sportive de Tataouine</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
