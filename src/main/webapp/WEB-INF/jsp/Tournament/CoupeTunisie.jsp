	...
	<section class="container">
		<div class="row">
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> La coupe de Tunisie de football
					(كأس تونس لكرة القدم), est une compétition de football mise en
					place en 1922, La coupe de Tunisie de football (كأس تونس لكرة
					القدم), est une compétition<span> de football mise en place
						en 1922, organisée par la Ligue de Tunisie de football puis par la
						Fédération tunisienne de football après 1956.</span><a href=""
		...
		<div class="row">
			<section class="col-md-12">
				<table class="table table-hover ">
					<h2 class="block-header text-center">Tickets de Coupe Tunisie</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
