	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url
					value="/resources/images/ligue1pro/CS_Hammam-Lif-Logo-2008.gif"
					var="logo" />
				<img src="${logo}" alt="CSHL" />
			</div>
			<div class="col-sm-2" id="logo">
				<img src="../images/ligue1pro/CS_Hammam-Lif-Logo-2008.gif"
					alt="CSHL" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">Le Club sportif
				de Hammam Lif (النادي الرياضي لحمام الأنف) ou CSHL est un club
				tunisien de football fondé en 1944. Le club aux couleurs vert et
				blanc évolue en Ligue I.</div>
		</div>
	</section>
	<nav class="container">
		<div class="row">
			<section class="col-sm-12 ">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de Club sportif de Hammam Lif</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
