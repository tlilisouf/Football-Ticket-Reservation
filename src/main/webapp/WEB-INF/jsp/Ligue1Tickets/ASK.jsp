	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue1pro/Asklogo.png"
					var="logo" />
				<img src="${logo }" alt="ASK" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> L'Avenir Sportif de Kasserine
					(المستقبل الرياضي بالقصرين) ou ASK est un club tunisien de football
					fondé à Kasserine en 1948. Au cours de la saison 2009-2010, il
					réalise un <span>parcours lors duquel il bat les cinq
						premiers du championnat mais perd contre les derniers, ce qui le
						condamne à la rétrogradation en Ligue II. Il y passe cinq saisons
						avant de retrouver sa place en Ligue I à l'issue de la saison
						2014-2015.</span><a href="" class="morelink center-block text-center">Lire
						plus</a>
				</span>
			</div>
			...
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						Avenir sportif de Kasserine</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
