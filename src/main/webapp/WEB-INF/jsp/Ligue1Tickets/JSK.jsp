	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url
					value="/resources/images/ligue1pro/Jeunesse_sportive_kairouanaise.png"
					var="logo" />
				<img src="${logo}" alt="JSK" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> La Jeunesse Sportive Kairouanaise
					(الشبيبة الرياضية القيروانية) ou JSK est un club de football
					tunisien basé à Kairouan et fondé en 1942. Le club aux couleurs
					vert et blanc évolue en<span> 2005-2006 en Ligue I avant
						d'être relégué en Ligue II. À l'issue de la saison 2008-2009, il
						termine second et accède à nouveau en Ligue I.</span><a href=""
