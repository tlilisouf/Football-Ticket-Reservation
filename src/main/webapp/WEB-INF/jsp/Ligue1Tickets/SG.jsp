	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url
					value="/resources/images/ligue1pro/Logo_Stade_Gab%C3%A9sien_(SVG).svg.png"
					var="logo" />
				<img src="${logo}" alt="SG" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> Le Stade gabésien (الملعب الڨابسي)
					est un club tunisien de football fondé en 1957.Le Stade<span>
						gabésien évolue au stade de Zrig et s'entraîne au stade Omar
						Doghman.</span><a href="" class="morelink center-block text-center">Lire
						plus</a>
				</span>
			</div>
		</div>
