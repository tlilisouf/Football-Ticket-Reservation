	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url
					value="/resources/images/ligue1pro/EGSG_Logo_(SVG).svg.png"
					var="logo" />
				<img src="${logo}" alt="EGSG" />
			</div>

			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> El Gawafel sportives de Gafsa
					(القوافل الرياضية بقفصة) ou EGSG est un club tunisien de football
					fondé en 1967 et basé à Gafsa. Le club évolue depuis 2004-2005 en
					Ligue I.<span>Le nom tunisien fait référence aux caravanes
						dont la ville de Gafsa constitua longtemps un point de passage.</span><a
			...
			<section class="col-sm-12">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						El Gawafel sportives de Gafsa</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
