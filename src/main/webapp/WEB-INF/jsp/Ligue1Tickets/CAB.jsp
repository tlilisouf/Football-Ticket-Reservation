	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue1pro/CA_Bizertin.gif"
					var="logo" />
				<img src="${logo}" alt="CAB" />
			</div>
			<div class="jumbotron col-centered col-sm-7">
				<span class="morecontent">Le Club athlétique bizertin (النادي
					الرياضي البنزرتي) ou CAB est un club de football tunisien fondé à
					Bizerte en 1928.L'équipe est la première en Tunisie à remporter une
					coupe<span> africaine, le 3 décembre 1988, au stade
						olympique d'El Menzah à Tunis.</span><a href=""
			...
			<section class="col-sm-12 ">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						de Club athlétique bizertin</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
