	...
	<section class="container">
		<div class="row">
			<div class="col-sm-2" id="logo">
				<spring:url value="/resources/images/ligue1pro/Asm.png" var="logo" />
				<img src="${logo}" alt="ASM" />
			</div>
			<div class="jumbotron col-centered col-sm-7 ">
				<span class="morecontent"> L'Avenir sportif de La Marsa
					(المستقبل الرياضي بالمرسى) ou ASM est un club de football tunisien<span>
						basé à La Marsa. Fondé en 1939 par M'hamed Zaouchi sous le nom
						originel d'Avenir musulman, il évolue en 2014-2015 en Ligue I. </span><a
			...
			<section class="col-sm-12 ">
				<table class="table table-hover">
					<h2 class="block-header text-center">Les tickets de football
						d'Avenir sportif de La Marsa</h2>
					<thead>
						<tr class="head">
							<th>Tournoi</th>
							<th>Date</th>
