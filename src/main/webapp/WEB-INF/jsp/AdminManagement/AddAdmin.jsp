		...
		<div class="row">
			<div class="list-group col-sm-3">
				<a href="SuperAdminAccount" class="list-group-item ">Modifier <a
					href="AddAdmin" class="list-group-item active">Ajouter
			...
			<div class="col-sm-10 col-sm-push-1">
				<spring:url value="AdminRegistration" var="adminRegistration" />
				<form class="form-horizontal" role="form" method="post"
					action="${adminRegistration }" id="RegisterForm">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control" name="gouvernorat" id="gouvernorat">
								<option value='<c:out value="${adminRegister.town }"/>'>${adminRegister.town }</option>
							</select>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control" name="delegation" id="delegation">
								<option value='<c:out value="${adminRegister.region }"/>'>${adminRegister.region }</option>
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control" name="sex" id="sex">
								<option value='<c:out value="${adminRegister.sex }"/>'>${adminRegister.sex }</option>
					...
					<div class="form-group " id="user_name_field">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="userName"
								id="userName" placeholder="" read
								value='<c:out value="${adminRegister.sooId }"/>' required>
					...
					<div class="form-group " id="billing_first_name_field">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="firstName"
								...
								value='<c:out value="${adminRegister.firstName }"/>' required>
						</div>
					</div>
					<div class="form-group" id="billing_last_name_field">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control " name="lastName"
								...
								value='<c:out value="${adminRegister.lastName }"/>' required>
						</div>
					</div>
						...
						<div class="col-sm-9">
							<div class="input-group date" id="dp3" data-date="20-02-2016"
								...
								<input class="form-control" type="text"
									...
									value='<c:out value="${adminRegister.birthday }"/>' required>
					...
					<div class="form-group" id="billing_password_field">
						...
						<div class="col-sm-9">
							<input type="password" data-minlength="6" class="form-control"
								...
								value='<c:out value="${adminRegister.password }"/>' required>
						</div>
					</div>
					...
					<div class="form-group" id="billing_company_field">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control " name="comapanyName"
								...
								value='<c:out value="${adminRegister.company }"/>'>
						</div>
					</div>
					<div class="form-group" id="billing_address_fields">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control " name="address1"
								...
								value='<c:out value="${adminRegister.address }"/>' required />
					...
					<div class="form-group" id="billing_email_field">
						...
						<div class="col-sm-9">
							<input type="email" class="form-control " name="email" id="email"
								placeholder="email"
								value='<c:out value="${adminRegister.email }"/>' required>
					...
					<div class="form-group" id="billing_phone_field">
						...
						<div class="col-sm-9">
							<input type="tel" class="form-control " name="phoneNumber"
								...
								value='<c:out value="${adminRegister.phone }"/>' required>
						</div>
					</div>
					<div class="form-group">
