		...
		<div class="row">
			...
			<div class="list-group col-sm-7 ">
				<a href="SuperAdminAccount" class="list-group-item"> Modifier
					les infromations de compte </a> <a href="SuperAdminPasswordAlter"
					class="list-group-item active">Modifier mot de passe</a>

			</div>
			<div class="col-sm-9">
				<spring:url value="SuperAdminAlterPassword"
					var="SuperAdminAlterPassword" />
				<form class="form-horizontal" role="form" id="passwordAlter"
					action="${SuperAdminAlterPassword }" method="post">
